...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HeaderComponent, BannerWrapperComponent, HowItWorksComponent, ExploreComponent, StatisticsCounterComponent, NewsArticlesComponent, CreateAccountComponent, FooterComponent],
